...
public class GUIController : IDisposable {
  ...
  public void CreateDeviceResources() {
    ...
    var inPos = GL.GetAttribLocation(_shader.Program, "in_position");
    var inTex = GL.GetAttribLocation(_shader.Program, "in_texCoord");
    var inColor = GL.GetAttribLocation(_shader.Program, "in_color");
    ...
    GL.EnableVertexArrayAttrib(_vertexArray, inPos);
    GL.VertexArrayAttribBinding(_vertexArray, inPos, inPos);
    GL.VertexArrayAttribFormat(_vertexArray, inPos, 2, VertexAttribType.Float, false, 0);

    GL.EnableVertexArrayAttrib(_vertexArray, inTex);
    GL.VertexArrayAttribBinding(_vertexArray, inTex, inPos);
    GL.VertexArrayAttribFormat(_vertexArray, inTex, 2, VertexAttribType.Float, false, 8);

    GL.EnableVertexArrayAttrib(_vertexArray, inColor);
    GL.VertexArrayAttribBinding(_vertexArray, inColor, inPos);
    GL.VertexArrayAttribFormat(_vertexArray, inColor, 4, VertexAttribType.UnsignedByte, true, 16);
