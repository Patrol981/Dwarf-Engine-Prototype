...
public static class CameraToolbox {
  ...
  public static void CreateStaticCamera(ref Entity camera, ref Window window) {
    camera.AddComponent(new Transform(new Vector3(0, 0, 4)));
  ...
  public static void CreateOrthographicCamera(ref Entity camera, ref Window window) {
    camera.AddComponent(new Transform(new Vector3(0, 0, 10)));
